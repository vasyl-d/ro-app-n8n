...
export const BASE_URL:string = "https://api.orderry.com/";
...
export async function fetchCustomFieldsData(
	...
	let data = await this.helpers.httpRequestWithAuthentication.call(this, 'orderryApi', {
		method: 'GET',
		url,
		json: true,
	});
...
export async function getLocationResources(
	...
	const response = await this.helpers.httpRequestWithAuthentication.call(this, 'orderryApi', {
		method: "GET",
		url,
		json: true,
	});
...
export async function handleGetOne(
	...
	try {
		...
		return [[{
			json: await this.helpers.httpRequestWithAuthentication.call(this, 'orderryApi', {
				method: method,
				url: url,
				json: true,
				qs: qs,
...
export async function handleCreateUpdate(
	...
	try {
		...
		const responseData = await this.helpers.httpRequestWithAuthentication.call(this, 'orderryApi', {
			method: method,
			url: url,
			json: true,
			body: body
