...
export const bookingsGetManyDescription: INodeProperties[] = [
	{
		...
		default: [],
		description: 'Filter by booking status. Choose from the list, or specify an ID using an <a href="https://n8n.io">expression</a>. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	},
	{
