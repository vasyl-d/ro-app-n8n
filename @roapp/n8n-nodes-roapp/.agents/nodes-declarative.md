...
# Invoices Resource Declarative Structure

## Endpoint: /invoices
### GET (Get All Invoices)
- **Description**: Retrieves a list of invoices with optional filtering.
- **Parameters**:
    - `ids` (string[]): List of invoice IDs.
    - `numbers` (string[]): List of invoice numbers.
    - `payment_method` (string): Filter by payment method.
    - `statuses` (string[]): Filter by invoice statuses.
- **Response**: Array of Invoice objects.

### GET (Get Statuses)
- **Description**: Retrieves all available invoice statuses.
...
### POST (Add Comment)
- **Description**: Adds a comment to a specific invoice.
- **Parameters**:
    - `invoice_id` (string): The unique ID of the invoice.
    - **Body**: Comment details (e.g., content).
...
## Endpoint: /invoices/{invoice_id}/items
### GET (Get Invoice Items)
- **Description**: Retrieves all line items associated with an invoice.
- **Parameters**:
    - `invoice_id` (string): The unique ID of the invoice.
